            ...
            <div className="p-4 relative">
              ...
              <Button
                ...
                onClick={(e) => {
                  ...
                  navigate(createPageUrl("transform", languageForLinks), {
                    state: {
  ...
  return (
    <>
      <Helmet>
        ...
        />
         <link rel="canonical" href={`${canonicalBase}/gallery`} />
      </Helmet>
      <SignedIn>
        <div className="min-h-screen px-6 pb-20 pt-32 bg-gradient-to-b from-white via-gray-50 to-gray-100">
          <div className="mx-auto max-w-7xl text-center">
            ...
            <div className="mb-16">
              ...
              <Button
                onClick={() => navigate(createPageUrl("transform", languageForLinks))}
