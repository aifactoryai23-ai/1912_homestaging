...
import { replaceLanguageInPath } from "@/utils";
...
const LANGUAGES = [
  ...
  { code: "ja", countryCode: "JP", nameKey: "languageSwitcher.japanese" },
  { code: "ko", countryCode: "KR", nameKey: "languageSwitcher.korean" }
];
...
export default function LanguageSwitcher({ className }) {
  ...
  const handleChange = async (code) => {
    ...
    const nextPath = replaceLanguageInPath(location.pathname, code);
